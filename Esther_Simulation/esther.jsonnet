...
function(nsims=1, outputpath = "outputs/", outputfilename="res",
  ...
  "Simulation Parameters": lib.simulation(nsims, outputpath, outputfilename),
  "Journal Parameters": lib.journal(pubbias, maxpubs, alpha, side),
  "Experiment Parameters": lib.experiment(ndvs, nobs, mu, sd, cov),
  "Researcher Parameters": lib.researcher(ishacker, selpref, hacks, hackid)
}