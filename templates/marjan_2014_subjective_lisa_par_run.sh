...
export STOPOS_POOL=marjan_2014_subjective_pool
...
SAMoo_DIR=${PROJECT_DIR}/projects/marjan_2014_subjective
...
rm -rf ${TMPDIR}/marjan_2014_subjective
PROJECT_TMP_DIR=${TMPDIR}/marjan_2014_subjective
...
(
	...
	stopos next -p marjan_2014_subjective_pool
	...
	stopos remove -p marjan_2014_subjective_pool
